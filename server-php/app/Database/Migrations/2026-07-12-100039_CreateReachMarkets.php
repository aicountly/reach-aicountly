...
class CreateReachMarkets extends Migration
{
    public function up(): void
    {
        $this->forge->addField([
            ...
            'country_codes'        => ['type' => 'JSONB', 'null' => true],
            'jurisdiction_notes'   => ['type' => 'TEXT', 'null' => true],
        ...
        $this->forge->createTable('reach_markets', true);

        $this->db->query(
            "ALTER TABLE reach_markets ADD CONSTRAINT reach_markets_status_chk "
    ...
    {
        $this->forge->dropTable('reach_markets', true);
    }
}
