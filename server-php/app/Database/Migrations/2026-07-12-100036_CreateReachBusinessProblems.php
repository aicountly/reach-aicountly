...
class CreateReachBusinessProblems extends Migration
{
    public function up(): void
    {
        ...
        $this->forge->createTable('reach_business_problems', true);

        $this->db->query(
            "ALTER TABLE reach_business_problems ADD CONSTRAINT reach_business_problems_status_chk "
    ...
    {
        $this->forge->dropTable('reach_business_problems', true);
    }
}
