...
class CreateReachPersonas extends Migration
{
    public function up(): void
    {
        $this->forge->addField([
            ...
            'role_title'          => ['type' => 'VARCHAR', 'constraint' => 200, 'null' => true],
            'description'         => ['type' => 'TEXT', 'null' => true],
            'pain_points'         => ['type' => 'JSONB', 'null' => true],
            'goals'               => ['type' => 'JSONB', 'null' => true],
        ...
        $this->forge->createTable('reach_personas', true);

        $this->db->query(
            "ALTER TABLE reach_personas ADD CONSTRAINT reach_personas_status_chk "
    ...
    {
        $this->forge->dropTable('reach_personas', true);
    }
}
